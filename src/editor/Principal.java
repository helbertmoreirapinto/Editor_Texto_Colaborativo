...
//                  Menu Principal
    ...
    /**
     * Pede ao usuario um login e senha e verifica se são validos para acessar o
     * sistema
     *
     * @param s
     * @return
     ...
     * @throws FileNotFoundException
     * @throws IOException
     * @throws UsuarioInativoException
     */
    ...
    /**
     * Medoto inicial para o CRUD de usuario
     *
     * @param s
     * @throws NoSuchAlgorithmException
     * @throws IOException
...
//		Menu Usuario
    ...
    /**
     * Metodo onde pega as informações e insere no arquivo de dados um usuario
     *
     * @param s
     * @throws IOException
     * @throws NoSuchAlgorithmException
    ...
    /**
     * Colsulta os usuarios cadastrados
     *
     * @param s
     * @param usuarioList
     * @return
...
//		Menu Consulta Usuario
     ...
     */
    /**
     * Seleciona quais usuarios terao acesso a ver/editar/apagar dados no
     * arquivo
     *
     * @param s
     * @return
    ...
    /**
     * Este metodo edita o texto contido no arquivo.
     *
     * @param s
     * @param arq
     * @throws IOException
...
//		Menu editar
                ...
                switch (opc) {
                    case MENU_EDIT_INS:
                        for (int i = (historico_alteracao.size() - 1); i > ind_alteracao; i--) {
                            historico_alteracao.remove(i);
                        }
                        System.out.print("Texto: ");
                        texto.add(s.nextLine());
                        System.out.println(historico_alteracao.size());
                        break;
    ...
    /**
     * Seleciona uma linha especifica do arquivo
     *
     * @param s
     * @param max
     * @return
    ...
    /**
     * Menu principal do subsistema de arquivos
     *
     * @param s
     * @param user
     * @throws CriarDiretorioException
     * @throws IOException
     */
...
//		Menu de Arquivo
                ...
                System.out.println("2 - Consultar Arquivo");
                System.out.println("0 - Voltar");
                System.out.print("Selecione: ");
                opcaoMenu = s.nextInt();
                System.out.print("\n");
    ...
    /**
     * Exibe os arquivos que o usuario tem acesso
     *
     * @param s
     * @param user
     * @return
    ...
    /**
     * Insere um arquivo no diretorio
     *
     * @param s
     * @param user
     * @throws IOException
     * @throws NewFileException
